<?php $__env->startSection('fullscreen', true); ?>
<?php $__env->startSection('body_class', 'admin-dashboard min-h-screen overflow-x-hidden selection:bg-[var(--admin-primary-soft)] selection:text-[var(--admin-primary)]'); ?>
...
<style>
    :root {
        ...
        --admin-primary: <?php echo e($party['colors']['primary']); ?>;
        --admin-primary-soft: <?php echo e($party['colors']['primary_soft']); ?>;
    }
    html.dark {
        --admin-bg: #0a0d14;
...
<aside class="admin-mobile-drawer admin-sidebar flex flex-col border-r backdrop-blur-xl">
    <div class="p-5 flex items-center justify-between border-b admin-border">
        <div class="flex items-center gap-3">
            <div class="admin-primary-bg w-8 h-8 rounded-lg overflow-hidden flex items-center justify-center">
                <img src="<?php echo e(asset($party['assets']['logo'])); ?>" alt="<?php echo e($party['app_name']); ?> Logo" class="w-full h-full object-contain">
            </div>
            <div>
                <h1 class="admin-display admin-primary text-2xl leading-none"><?php echo e($party['app_name']); ?></h1>
                <span class="admin-mono admin-muted-soft text-[10px] uppercase tracking-widest"><?php echo e($roleLabel); ?></span>
            </div>
        </div>
    ...
    <nav class="flex-1 py-4 space-y-1 overflow-y-auto">
        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a class="admin-nav-item <?php echo e($adminActive === $menu['key'] ? 'active' : ''); ?>" href="<?php echo e($menu['route']); ?>">
                <span class="material-symbols-outlined <?php echo e($adminActive === $menu['key'] ? 'material-symbols-filled' : ''); ?>"><?php echo e($menu['icon']); ?></span>
    ...
    <aside class="admin-sidebar hidden md:flex flex-col h-screen sticky top-0 w-64 border-r backdrop-blur-xl z-[60]">
        <div class="p-6 flex flex-col gap-1">
            ...
            <div class="admin-primary-bg px-2 py-1 w-max rounded-sm">
                <span class="admin-display admin-primary uppercase text-[10px] tracking-[.2em]"><?php echo e($roleLabel); ?></span>
            </div>
        </div>
        ...
        <div class="p-4 mt-auto border-t admin-border">
            <a href="<?php echo e(route('password.edit')); ?>" class="w-full flex items-center gap-4 admin-muted px-6 py-3 hover:text-[var(--admin-primary)] transition">
        ...
        <header class="admin-topbar sticky top-0 z-50 min-h-16 w-full flex flex-wrap gap-3 justify-between items-center px-4 lg:px-8 py-3 backdrop-blur-md border-b shadow-sm">
            <div class="flex items-center gap-4">
                ...
                <div class="hidden lg:block">
                    ...
                    <p class="admin-text text-sm font-semibold leading-tight"><?php echo e($party['tagline']); ?></p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-3">
                    <div class="text-right hidden sm:block">
                        <p class="admin-text text-xs font-bold leading-none"><?php echo e(strtoupper(Auth::user()->name)); ?></p>
                        <p class="admin-muted text-[10px] leading-none mt-1"><?php echo e($userRoleLabel); ?></p>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\simap-partai-template\resources\views/layouts/admin.blade.php ENDPATH**/ ?>